-- List of appointments an individual has held, with:
...
(
    ...
    from appointment a
        ...
        inner join person p2 on
            p1.id = p2.id and
		    a.person_id = p2.id and
            isnull(a.start_date, '1900-01-01') >= isnull(p2.start_date, '1900-01-01') and
            isnull(a.start_date, '1900-01-01') < isnull(p2.end_date, '9999-12-31')
