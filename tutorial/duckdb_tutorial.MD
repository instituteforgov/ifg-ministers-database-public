...
\
\
If you look in the `data` folder you should see multiple CSV files - one for each table in the database - and one SQLite data. For the purposes of this tutorial, we'll use the CSV files.
\
